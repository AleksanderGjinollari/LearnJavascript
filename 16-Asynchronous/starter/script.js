...
// get3Countries('albania', 'kosovo', 'germany');

// Promise.race
(async function () {
  const res = await Promise.race([
    getJSON(`https://restcountries.com/v2/name/italy`),
    getJSON(`https://restcountries.com/v2/name/albania`),
...
Promise.race([getJSON(`https://restcountries.com/v2/name/china`), timeout(1)])
